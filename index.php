...
<div id="home" class="header">
    ...
    if(!empty($_SESSION['message'])){
        ...
        <div class="alert alert-warning alert-dismissible" role="alert">
            <p class="text-center"><?php echo $_SESSION['message']; ?>
...
<!--                <div class="alert alert-error">--><?php //$_SESSION['message']=null; ?><!--</div>-->
                <input type="text" name="first_name" value="First Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'First Name';}"  input data-validation="length alphanumeric" data-validation-length="min4" />
                <input type="text"name="last_name" value="Second Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Second Name';}" input data-validation="length alphanumeric" data-validation-length="min4" />
