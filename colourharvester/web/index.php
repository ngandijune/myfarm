...
<!--                    <li><a href="common/colour-index.html" target="_blank"><i><img src="web/images/favourite.png" alt="" /></i>Colour Index</a></li>-->
                    <li><a href="common/maizesilks.zip" target="_self"><i><img src="web/images/invites.png"></i>Test Data </a></li>
                    <div class="clear"></div>
                </ul>
...
<div class="copy-right">
    ...
    <p style="display:none">© 2019 Designed by <a href="http://graphicburger.com/flat-design-ui-components/" target="_blank">june</a>  • Template by <a href="http://w3layouts.com" target="_blank">w3layouts</a> </p>
</div>
...
?>
    ...
    <script>
        ...
        document.getElementById('colour-box-desired').style.backgroundColor = "rgb(147,91,59)";
        ...
        document.getElementById('colour-box-desired-text').innerHTML += "rgb(147,91,59)<br>Forest-brown";
        ...
        function plotGauge(red, green, blue) {
            ...
            pureDegreeOfPerfection = (Colordiff.compare({r:147, g:91, b:59}, {r: ascendantColour[0], g: ascendantColour[1], b: ascendantColour[2]}, 'rgb'));

            // degreeOfPerfection = (Colordiff.compare({r:145, g:192, b:57},
            // degreeOfPerfection = (Colordiff.compare({r:106, g:38, b:39},
            degreeOfPerfection = (Colordiff.compare({r:147, g:91, b:59},
                ...
                (Colordiff.compare({r:106, g:38, b:39}, {r: 147, g: 91, b: 59}, 'rgb'))*100;
