...
<!DOCTYPE HTML>
<head>
<title>Smart Harvester - mobile</title>

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

<link href="mobile/css/style.css" rel="stylesheet" type="text/css" media="all"/>
<link href="mobile/css/clndr.css" rel="stylesheet" type="text/css" media="all"/>
	      ...
	      <div class="header">
	      	  <div class="header_top">					
					  <div class="profile_details">
				                            <div class="user-info">
							        			<img src="mobile/images/settings.png" alt="" />
							        			<ul>
							        				<li class="profile"><a href="index.php?browser_t=web&page_name=index.php">Desktop</a></li>
							        				<li> | </li>
							        				<li class="profile"><a href="index.php?browser_t=smartphone&page_name=index.php">Tablet</a></li>
							        				<li> | </li>
							        				<li class="profile active"><a href="index.php?browser_t=mobile&page_name=index.php">Mobile</a></li>
													
													
													<li><a href="#prediction-div"><i><img src="mobile/images/statistics.png"></i>Prediction</a></li>
													<li><a href="#prescription-div"><i><img src="mobile/images/events.png"></i>Prescription</a></li>
													<li><a href="common/colour-index.html" target="_blank"><i><img src="mobile/images/favourite.png" alt="" /></i>Colour Index</a></li>
													<li><a href="common/pawpaw-fruit-images-for-demo1.zip" target="_self"><i><img src="mobile/images/invites.png"></i>Test Data</a></li>	
							        				<div class="clear"></div>		
							        			</ul>
							        		</div>			                            
				               <div class="profile_img">	
				             	   <a href=""><img src="mobile/images/profile_img40x40.jpg" alt="" />	</a>				                </div>		
				             <div class="clear"></div>		  	
					    </div>	
		 		      <div class="clear"></div>				 
				   </div>
