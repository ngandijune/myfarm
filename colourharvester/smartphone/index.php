...
<!DOCTYPE HTML>
<head>
<title>Smart Harvester - tablet</title>
...
<script type="text/javascript" src="smartphone/js/login.js"></script>
<script type="text/javascript" src="smartphone/js/Chart.js"></script>
 ...
 <!----Calender -------->
  ...
  <script src="smartphone/js/site.js"></script>
  <!----End Calender -------->
	      	  ...
	      	  <div class="header_top">
					  ...
					  <div class="profile_details">
				    		   <div id="loginContainer">
				                  <a id="loginButton" class=""><span></span><img src="smartphone/images/settings.png" alt="" /></a>   
				                    <div id="loginBox">                
				                      <form id="loginForm">
				                        <fieldset id="body">
				                            <div class="user-info">
							        			<ul>
							        				<li class="profile"><a href="index.php?browser_t=web&page_name=index.php">Desktop</a></li><br><br>
							        				<li class="profile active"><a href="index.php?browser_t=smartphone&page_name=index.php">Tablet</a></li><br><br>
				             ...
				             <div class="profile_img">	
				             	<a href=""><img src="smartphone/images/profile_img40x40.jpg" alt="" />	</a>
				             </div>		
				             <div class="clear"></div>		  	
					    </div>	
		 		      <div class="clear"></div>				 
...
<!--/*************************NEEDED FOR IMAGE UPLOAD AND PREPROCESSING************************end*/-->
    	...
    	<div class="clear"></div>
   					...
   					<nav id="menu">
							<ul>
								<li><a href="#prediction-div"><i><img src="smartphone/images/statistics.png"></i>Prediction</a></li>
								<li><a href="#prescription-div"><i><img src="smartphone/images/events.png"></i>Prescription</a></li>
								<li><a href="common/colour-index.html" target="_blank"><i><img src="smartphone/images/favourite.png" alt="" /></i>Colour Index</a></li>
								<li><a href="common/pawpaw-fruit-images-for-demo1.zip" target="_self"><i><img src="smartphone/images/invites.png"></i>Test Data </a></li>							
							</ul>
					 </nav>
					  <div class="copy-right">
					  <p>Contact: allan[at]odhiambo.me.ke</p>
