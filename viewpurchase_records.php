            ...
            <table class="table table-bordered table-hover table-striped" style="table-layout: fixed">
                ...
                while($row=mysqli_fetch_array($run))//while look to fetch the result and store in a array $row.
                {
                    ...
                    <tr>
                        ...
                        <td><a href="delete_records.php?del=<?php echo $item_id ?>"><button class="btn btn-danger">Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->
                        <td><a href="edit_records.php?del=<?php echo $item_id ?>"><button class="btn btn-primary">Edit</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->
                    </tr>
